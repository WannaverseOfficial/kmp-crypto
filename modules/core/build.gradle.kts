...
android {
    namespace = "com.wannaverse.crypto.core"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "kmp-crypto-core", version.toString())

    pom {
        name = "kmp-crypto-core"
        description = "A cryptographic library for Kotlin Multiplatform"
        inceptionYear = "2025"
